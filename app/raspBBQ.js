...
//    R1 = 340e3,          // Resistor used in voltage divider
    ...
    ADCResolution = 0;   // resolution of ADC (0=12 bit, 1=14 bit, 2=16 bit, 3=18 bit)
...
var bbq = {
    readTemp: function (channel, callback) {
        ...
        if (v > 2.046) {
            callback(null, null);  // probe not connected or reading below scale
        } else {
